...
public class DatabaseBehavior {
    ...
    private static ArrayList<AccountPackage> getClientAccountList(SQLiteDatabase myDB, Cursor cursor)
    {
        ...
        for(int i = 0;i < cursor.getCount(); i++)
        {
            ...
            tempAccount.setType(cursor.getInt(9) == 0 ? false : true);     //Type at location 9 (need to be modify)
            tempAccount.setID(cursor.getInt(10));       //ID need to be modify.
            tempAccount.setUser("123");                             //DEBUG
