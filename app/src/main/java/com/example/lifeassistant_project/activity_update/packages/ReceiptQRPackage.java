...
public class ReceiptQRPackage extends DataPackage{
    private String year, month;
    private ArrayList<String> hitNumber;

    public ReceiptQRPackage()
    {
        this.year = "2000";
        this.month = "01";
    ...
    public ReceiptQRPackage(String year, String month, ArrayList<String> hitNumber)
    {
        this.year = year;
        this.month = month;
...
//            System.out.println(PackageHandler.TransByteArray2String(b_buf.array(), b_buf.array().length));
            ...
            ReceiptQRPackage rcvReceipt = PackageHandler.ReceiptQRPackageDecode(rcvArray);
